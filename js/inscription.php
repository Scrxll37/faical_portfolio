...
<header id="default_header" class="header_style_1">
  ...
  <div id="small_titles">
    ...
    <form action="action.php" method="post">
      ...
      <input type="text" maxlength="15" placeholder="Choisissez votre pseudo" name="pseudo" required>


        <label for="mdp"><b>Mot de passe</b></label>
        <input type="password" maxlength="17" placeholder="Enterez mot de passe" name="mdp" required>

        <label for="mdp2"><b>Confirmez le mot de passe</b></label>
        <input type="password" maxlength="16" placeholder="Confirmez le mot de passe" name="mdp2" required>
        

        <label for="nom"><b>Nom</b></label>
        <input type="text" maxlength="20" placeholder="Nom" name="nom" required>

        <label for="prenom"><b>Prénom</b></label>
        <input type="text" maxlength="20" placeholder="Prénom" name="prenom" required>

        <label for="email"><b>L'adresse email</b></label>
        <input type="text" placeholder="Enterez l'adresse email" name="email" required>
     <input type="checkbox" name="box" value="F" /><b>Je suis pas un Robot</b><br />
...
<div class="section padding_layout_1">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="imgs/casque_razer.png" alt=""> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.html">casque_razer</a></h4>
            </div>
            <div class="starratin">
              <div class="center"> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i> </div>
            </div>
